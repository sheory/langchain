...
final_template = ChatPromptTemplate.from_messages(
    [
        ("ai", "Travel suggestion to the city: {city}"),
        ("ai", "Restaurants that you can lose: {restaurants}"),
        ("ai", "Activities and cultural places recommended: {cultural_places}"),
        ("system", "Combine the previous informations in 2 paragraphs")
    ]
)
...
part_4 = final_template | llm | StrOutputParser()

chain = (
    part_1 |
    {
        "restaurants": part_2,
        "cultural_places": part_3,
